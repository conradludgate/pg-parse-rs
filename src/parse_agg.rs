...
pub struct check_ungrouped_columns_context {
    ...
    pub have_non_var_grouping: bool,
...
unsafe extern "C" fn check_agg_arguments_walker(
    ...
    if (*(node as *const Node)).tag as libc::c_uint == T_Var as libc::c_int as libc::c_uint {
    ...
    if (*(node as *const Node)).tag as libc::c_uint == T_Aggref as libc::c_int as libc::c_uint {
    ...
    if (*(node as *const Node)).tag as libc::c_uint == T_GroupingFunc as libc::c_int as libc::c_uint
    {
...
unsafe extern "C" fn check_ungrouped_columns(
    ...
    mut have_non_var_grouping: bool,
...
unsafe extern "C" fn check_ungrouped_columns_walker(
    ...
    if (*(node as *const Node)).tag as libc::c_uint == T_Const as libc::c_int as libc::c_uint
        || (*(node as *const Node)).tag as libc::c_uint == T_Param as libc::c_int as libc::c_uint
    {
        return false;
    }
    if (*(node as *const Node)).tag as libc::c_uint == T_Aggref as libc::c_int as libc::c_uint {
    ...
    if (*(node as *const Node)).tag as libc::c_uint == T_Var as libc::c_int as libc::c_uint {
        ...
        if !(*context).have_non_var_grouping || (*context).sublevels_up != 0 {
            ...
            } != 0
            {
                ...
                if (*(gvar as *const Node)).tag as libc::c_uint
                    == T_Var as libc::c_int as libc::c_uint
    ...
    if (*(node as *const Node)).tag as libc::c_uint == T_GroupingFunc as libc::c_int as libc::c_uint
    {
        ...
        if (*grp).agglevelsup as libc::c_int == (*context).sublevels_up {
            ...
            } != 0
            {
                ...
                if (*(expr as *const Node)).tag as libc::c_uint
                    == T_Var as libc::c_int as libc::c_uint
                {
...
pub unsafe extern "C" fn build_aggregate_transfn_expr(
    ...
    *transfnexpr = fexpr as *mut Expr;
    if !invtransfnexpr.is_null() {
        if (invtransfn_oid != 0 as libc::c_int as Oid) as libc::c_int as bool != 0 {
            fexpr = makeFuncExpr(
                invtransfn_oid,
                agg_state_type,
                args,
